...
import com.xuzhenfei.server.model.UpdateUserInfoCase;
...
public class UpdateUserInfoTest {
    ...
    public void updateUserInfo() throws IOException, InterruptedException {
        ...
        System.out.println("需要更新为：" + updateUserInfoCase.toString());
        System.out.println("更新url为:" + TestConfig.updateUserInfoUrl);
        ...
        //获取更新后的结果
        Thread.sleep(3000);
        Users users = sqlSession.selectOne(updateUserInfoCase.getExpected(),updateUserInfoCase);
        System.out.println("更新后的用户信息为：" + users.toString());
...
//        Thread.sleep(2000);
    ...
    private int getResult(UpdateUserInfoCase updateUserInfoCase) throws IOException {
        ...
        param.put("sex",updateUserInfoCase.getGender());
